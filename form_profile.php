...
<body>
	<div class="container-fluid">
		...
		<!---->
			<!--ini bagian profil-->
						<div class="card" style="width: 980px; height: 615px; margin-top: -10px; padding: 10px; background-image: url(IMG/sk.png);">
						  <img src="IMG/b1.jpg" class="card-img-top" alt="..." height="265">
						  <div class="card-body" style="text-align: center;">
						  	<img src="IMG/user1.png" width="270" height="200" style=" margin-top: -120px; margin-bottom: 20px; " class="rounded" alt="ini gambar">
						    <h5 class="card-title text-center"><?php echo $nama['nama'];  ?></h5>
						    <p style="color: grey; m"><i class="fa fa-whatsapp" aria-hidden="true"></i></i><i style="margin-left: 10px;"></i>| Whastap : <?php echo $telpon['telpon'];  ?> </p>
						    <button type="button" class="btn btn-primary" style="width: 300px;"><a href="dataservice.php" style="color: white; text-decoration: none;">Data Service</a></button>
						  </div>
						</div>
			<!--tutup profil-->
