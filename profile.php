	...
	<div class="container-fluid">
		...
		<!-- BAGIAN NAV-->
					<ul class="nav justify-content-center ">
					  ...
					  <li class="nav-item">
					    <a class="nav-link" href="#" style="color: white; font-weight: bold;">TENTANG KAMI</a>
					  </li>
					  <li class="nav-item">
		...
		<div class="row">
			<div class="col col2">
		<!-- BAGIAN GAMBAR-->
				<div class="gambar" style="margin-bottom: 150px;">
					<img src="IMG/b9.png" class="img-fluid" alt="Responsive image" style="height: 400px;">
						<div class="judul" style="margin-top: -300px; margin-left: 700px;">
							...
							<div class="row" style="margin-left: 1px;">
								...
								<div class="col"><p style="margin-left: -15px; margin-top: -10px;">terhadap pelanggan. dan kami menawarkan anggilan murah yang bisa</p></div>
								<div class="col">
									<p style="margin-left: -15px; margin-top: -10px;">anda hubungi kapan saja, dan kami bisa datang langsung ketempat anda. </p>
								</div>
								</div>
							</div>
		...
		<!-- BAGIAN GAMBAR-->
				<div class="gambar" >
					<img src="IMG/v1.png" class="img-fluid" alt="Responsive image" style="height: 500px; width: 100%;">
						<div class="judul" style="margin-top: -300px; margin-left: 700px;">
