...
<body>
		...
		<div class="row">
			<div class="col col2">
				<ul class="nav nav-tabs mt-3">
				  ...
				  <li class="nav-item">
				    <a class="nav-link active" href="formstatus1.php" style="font-weight: bold; color:#FF8C00; ">Data Laptop</a>
				  </li>
				  <li class="nav-item">
	...
	<!--bagian table laptop-->
		<div class="latar" style="padding: 10px; border: 5px solid; margin-top: 50px;">
			<h4 style="background-color: orange; border-radius: 15px 15px 15px 15px; margin-top: -37px; font-weight: bold;margin-bottom: 20px; width: 200px; padding: 10px;">Laptop Service</h4>
			<div class="ltable" style=" font-weight: bold; ">
		       ...
		       <table id="example2" class="table" style="width:100%; background-color: #1282b2; text-align: center; margin-bottom: 20px;">
		        ...
		        <tbody>
					...
					<tr>
						<td scope="row"><?php echo $no2++; ?></td>
						<td><?php 	echo $kode2.$data['no_antrian']; ?></td>
