...
<body>
	...
	<div class="container-fluid">
		...
		<!-- BAGIAN GAMBAR-->
				<div class="gambar">
					<img src="IMG/b9.png" class="img-fluid" alt="Responsive image" style="height: 400px;">
						<div class="judul" style="margin-top: -350px; margin-left: 700px;">
							<h4 class="display-4">Selamat Datang</h4>
							<div class="row" style="margin-left: 1px;">
								<div class="col col-9"><h4 style="font-weight: bold; color: #FF8C00; ">Beecom</h4><p>komputer, laptop, gadget, dan printer yang sangat terpercaya dan </p></div>
								<div class="col col-3"><p style="margin-left: -390px; margin-top: 5px;">Siap melayani anda dengan menawarkan jasa service </p></div>
								<div class="col"><p style="margin-top: -10px;">menguntungkan bagi pelanggan dengan prioritas pelayanan penuh</p>
								<div class="col"><p style="margin-left: -15px; margin-top: -10px;">terhadap pelanggan.</p></div>
								</div>
							</div>
		...
		<!-- BAGIAN LAYANAN-->
				<div class="layanan" style="background-color: white; height: 347px; padding: 40px;">
					<h1 style="text-align: center;"> Layanan Kami</h1>
					<hr style="margin-top: -32px; background-color: #333; width: 400px; margin-left: 60px;">
					<hr style="margin-top: -17px; background-color: #333; width: 400px; margin-right: 60px;">
					<div class="about">
					    ...
					    <div class="face face1">
					      <div class="isi-about">
					        ...
					        <div class="isi-about" style="text-align: justify;">
					        <p>Siap melayani anda dengan menawarkan jasa service yang menguntungkan bagi pelanggan dengan prioritas pelayanan penuh terhadap pelanggan.</p>  
					        <a href="#" style="margin-left: 38%;" data-toggle="modal" data-target="#exampleModal1">Service</a>
					        </div>
					      </div>
					  </div>
					  ...
					  <div class="box">
					    <div class="face face1">
					      <div class="isi-about" >
					        <img src="IMG/le.png" alt="" style="margin-top: 30px;">
					        <h3 style="margin-top: 15px;">Laptop</h3>
					      </div>
					    </div>
					        <div class="face face2">
					        <div class="isi-about" style="text-align: justify;">
					        <p>Siap melayani anda dengan menawarkan jasa service yang menguntungkan bagi pelanggan dengan prioritas pelayanan penuh terhadap pelanggan.</p>  
					        <a href="#" style="margin-left: 38%;" data-toggle="modal" data-target="#exampleModal2">Service</a>
					        </div>
					      </div>
					  </div>
					</div>
				...
				<div class="bg" style="background-color: #333; height: 358px; margin-top: -40px;"></div>
				<div class="bg2" style="background-color: white; height: 393px;"></div>

				<div class="layanan2" style=" margin-top: -683px; padding: 40px;">
					<img src="IMG/b7.png" style="position: absolute; width: 100%; height: 395px; margin-top: 250px; margin-left: -70px;" alt="">
					<div class="about">
					    ...
					    <div class="face face1">
					      <div class="isi-about">
					        ...
					        <div class="isi-about" style="text-align: justify;">
					        <p>Siap melayani anda dengan menawarkan jasa service yang menguntungkan bagi pelanggan dengan prioritas pelayanan penuh terhadap pelanggan.</p>  
					        <a href="#" style="margin-left: 38%;" data-toggle="modal" data-target="#exampleModal3">Service</a>
					        </div>
					      </div>
					  </div>
					  ...
					  <div class="box">
					    <div class="face face1">
					      <div class="isi-about" >
					        ...
					        <div class="isi-about" style="text-align: justify;">
					        <p>Siap melayani anda dengan menawarkan jasa service yang menguntungkan bagi pelanggan dengan prioritas pelayanan penuh terhadap pelanggan.</p>  
					        <a href="#" style="margin-left: 38%;" data-toggle="modal" data-target="#exampleModal4">Service</a>
					        </div>
					      </div>
					  </div>
					</div>
			...
			<form action="prosestbhk.php" method="post">
				  <fieldset>
				    ...
				    <div class="form-group">
				      ...
				      <small id="tambahHelp" class="form-text text-muted">Nama tidak boleh kosong.</small>
				    </div>
					 ...
					 <div class="form-group">
		    		  <label for="exampleTextarea">Alamat :</label>
		      			...
		      			<small id="tambahHelp" class="form-text text-muted">Alamat tidak boleh kosong.</small>
		    		</div>
					<!--<div class="form-group">
				    ...
				    <div class="form-group">
				      ...
				      <small id="tambahHelp" class="form-text text-muted">Telpon tidak boleh kosong.</small>
				    </div>
				    
				    <div class="form-group">
				      <label for="exampleInputPassword1">Nama Barang :</label>
				      <input type="text" class="form-control" name="nbpel" id="exampleInputPassword1" placeholder="Masukan Nama Barang">
				      <small id="tambahHelp" class="form-text text-muted">Nama barang produk tidak boleh kosong.</small>
				    </div>
				    <div class="form-group">
				      <label for="exampleSelect1">Kerusakan :</label>
				       ...
				       <small id="tambahHelp" class="form-text text-muted">kerusakan barang tidak boleh kosong.</small>
				    </div>
			...
			<form action="prosestbhl.php" method="post">
				  <fieldset>
				    ...
				    <div class="form-group">
				      <label for="exampleSelect1">Kerusakan :</label>
				       <input type="text" class="form-control" name="krsknpel" id="exampleInputtambah1" aria-describedby="tambahHelp" placeholder="Masukan Kerusakan">
				       <small id="tambahHelp" class="form-text text-muted">Kerusakan tidak boleh kosong.</small>
				    </div>
