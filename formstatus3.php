		...
		<div class="row">
			<div class="col col2">
				<ul class="nav nav-tabs mt-3">
				  ...
				  <li class="nav-item">
				    <a class="nav-link" href="formstatus2.php">Data Android</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link active" href="formstatus3.php" style="font-weight: bold; color:#FF8C00; ">Data Printer</a>
				  </li>
				</ul>
		

	<!--bagian table printer-->
		<div class="latar" style="padding: 10px; border: 5px solid; margin-top: 50px;">
			<h4 style="background-color: orange; border-radius: 15px 15px 15px 15px; margin-top: -37px; font-weight: bold;margin-bottom: 20px; width: 200px; padding: 10px;">Printer Service</h4>
			<div class="ltable" style=" font-weight: bold; ">
		  	
		       <table id="example4" class="table" style="width:100%; background-color: #1282b2; text-align: center; margin-bottom: 20px;">
		        ...
		        <tbody>
					...
					<tr>
						<td scope="row"><?php echo $no4++; ?></td>
						<td><?php 	echo $kode4.$data['no_antrian']; ?></td>
