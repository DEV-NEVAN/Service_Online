			...
			<div class="col" style="padding: 50px;">
				<div class="card" style="width: 25rem;">
				  ...
				  <div class="card-body" style="">
					...
					<!-- bagian form login -->
				    <form style="text-align: center;" action="prosesteknisi.php" method="post">
						  <fieldset>
						...
						<div class="form-group">
					      <select  class="form-control" name="bidangt" style="background-color: orange; color: #333; font-weight: bold;">
					      	<option>Pilih Bidang Teknisi</option>
		...
		<div class="modal fade mod" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content mdl">
		      <div class="modal-header" style="background-color:#FF8C00; color: #333;">
		        <h5 class="modal-title" id="exampleModalLabel" style="font-weight: bold;" ><i class="fa fa-user-plus fa-2x" style="color: white; width: 60px;"></i>Form Registrasi</h5>
		      ...
		      <div class="modal-body">
		        <form action="prosesregis.php" method="post">
				  <fieldset>
				    ...
				    <div class="form-group">
				      ...
				      <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Alamat" name="alareg" style="border-radius: 0px 25px 25px 0px;">
				      </div>
				    </div>
				...
				<p>Back to <a href="form_login.php">Login</a></p>
				</center>
				</form>
