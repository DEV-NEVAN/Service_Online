	...
	<div class="container-fluid">
				    ...
				    <ul class="navbar-nav">
				      ...
				      <li class="nav-item dropdown">
				        ...
				        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="margin-left: -100px;">
				          <a class="dropdown-item" href="form_login.php" style="color: #333;">Login</a>
				          <a class="dropdown-item" href="form_login.php" style="color: #333;">Daftar</a>
					...
					<div class="about">
					    ...
					    <div class="face face1">
					      <div class="isi-about">
					        ...
					        <a href="form_login.php" style="margin-left: 38%;">Service</a>
					        </div>
					      </div>
					  </div>
		...
		<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 		 <div class="modal-dialog" role="document">
    		<div class="modal-content" style="border-color: #333; border: 5px solid; border-radius: 25px;">
      		...
      		<div class="modal-body" style="border: 2px solid; border-color: #333;">
